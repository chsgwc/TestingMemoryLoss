...
public class AddReminderActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mCurrentReminderUri == null) {
            ...
            // make it so it doesn't give option to delete if none there, still need to add code?
        ...
        if (savedInstanceState != null) {
            ...
            //doesn't work if i set emulator to military time
        ...
        //don't think this will work if you delete the very first one but ughghh its late
        ...
        //should be able to press if already one there
        //work on tjhis
    ...
    @Override
    protected void onSaveInstanceState (Bundle outState) { //this is never reached
    ...
    public void onTimeSet(RadialPickerLayout view, int hourOfDay, int minute) {
        //Maddie test this with exact hours for formatting, doesn't crash -
        mHour = hourOfDay;
        mMinute = minute;
        if (minute < 10) {
    ...
    /**
     *call after invalidateOptionsMenu() bc need to update menu!!! (some menu items can be hidden or made visible).
     */
    @Override
        ...
        switch (item.getItemId()) {
            ...
            case R.id.save_reminder:
                ...
                if (mTitleText.getText().toString().length() == 0){
                    mTitleText.setError("Item Title cannot be blank!");
                }
...
*/
        ...
        if (mCurrentReminderUri == null) {
            ...
            //THIS COULD BE AN ISSUE - NERURI IS NULL, but calling time from database works... - not anymore!
            Uri newUri = getContentResolver().insert(AlarmReminderContract.AlarmReminderEntry.CONTENT_URI, values);

            //testing if it shows when new  reminder
            //Toast.makeText(this, getString(R.string.editor_insert_reminder_successful), Toast.LENGTH_SHORT).show(); //we should see this

            // Show a toast message depending on whether or not the insertion was successful.
            if (newUri == null) {
                // If the new content URI is null, then there was an error with insertion.
                Toast.makeText(this, getString(R.string.editor_insert_reminder_failed), //IT'S GOING IN HERE! - not anymore!
                        Toast.LENGTH_SHORT).show();
            } else {
                // Otherwise, the insertion was successful and we can display a toast.
                Toast.makeText(this, getString(R.string.editor_insert_reminder_successful), //we should see this, yay! newUri not null anymore!
                Toast.LENGTH_SHORT).show();
            }
        } else { //only called when updating
        ...
        if (mActive.equals("true")) { //probably false when it should be true
                new AlarmScheduler().setRepeatAlarm(getApplicationContext(), selectedTimestamp, mCurrentReminderUri, milDay);
//UNCOMMENT LATER            Toast.makeText(this, "Scheduled time is " + selectedTimestamp,
//                    Toast.LENGTH_LONG).show();
        }

        // Create toast to confirm new reminder
//UNCOMMENT LATER:        Toast.makeText(getApplicationContext(), "Saved",
//                Toast.LENGTH_SHORT).show();
