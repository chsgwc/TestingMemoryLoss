...
public class AlarmReminderDbHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "alarmsDB.db"; //"alarmreminder.db";
...
//
//        String clearDBQuery = "DELETE FROM "+AlarmReminderContract.AlarmReminderEntry.TABLE_NAME;
